...
var DATA = {
  ...
  sertMtsTeta: {
    title: "Flutter",
    desc: "Изучение Dart и кроссплатформенной разработки в рамках корпоративного обучения.",
    slides: [
      {
        cls: "gradient-tag",
  ...
  sertOtus: {
    ...
    desc: "Успешное оконнчание курса по iOS-разработке от OTUS с дипломным проектом на GitHub.",
    slides: [
      {
        cls: "gradient-tag",
  ...
  upkOtus: {
    title: "Удостоверение о повышении квалификации (УПК)",
    desc: "Удостоверение государственного образца о повышении квалификации.",
    slides: [
      {
        cls: "gradient-tag",
